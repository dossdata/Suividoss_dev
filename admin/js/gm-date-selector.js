...
(function(window, document) {
    ...
    dateSelector.prototype = {
        ...
        drawSelector: function(){
            ...
            self.selector.style.left = position.x + 20 + 'px';
            self.selector.style.top = position.y + 60 + 'px';
    ...
    dateSelector.defaults = {
        ...
        months: {
            ...
            long: ['Janvier', 'Fevrier', 'Mars', 'Avril', 'May', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre']
        },
        navigateYear: true,
        outputFormat:'%Y-%m-%d',
        weekdays: {
            short: ['Dim', 'Lun', 'Mar', 'Merc', 'Jeu', 'Vend', 'Sam'],
