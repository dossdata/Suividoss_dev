...
var idsup = "";
	...
	var nomsuperviseur = "";
   		$.ajax({
        url: "php/Parametrage_par_cdm.php",
        type:'POST',
        data:{
            param:'collab',
        },
	        ...
	        success: function(data){
				...
				try {
					...
					for(var i = 0; i< data.length; i ++){
						list += "<tr><td class='idselect_c' style='display:none'>"+data[i].id +"</td><td class='nomE'>"+  data[i].code +"</td><td></td><td class='suprln text-center'><span class='glyphicon glyphicon-trash'></span></td></tr>";
					};
					$('#id_access_u').html(+data[0].manager);
